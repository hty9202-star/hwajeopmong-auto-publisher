...
- 브랜드 포함 예시:
  ...
  * "여드름 흉터, 화안케어로 개선할 수 있습니다"
  * "지루성피부염에 화접몽한의원이 제안하는 한방 치료"
  * "모공각화증 화안케어 치료 과정과 효과"` : `- 브랜드명(화접몽)은 제목에 넣지 않아도 됩니다. 질환 중심으로 작성하세요
- 일반 예시:
  * "편평사마귀, 단순 제거만으로는 부족합니다"
  * "모공각화증, 방치하면 반복됩니다"
  * "팔뚝의 오돌토돌한 돌기, 모공각화증일 수 있습니다"
  * "건선은 피부가 보내는 면역 신호입니다"`}
