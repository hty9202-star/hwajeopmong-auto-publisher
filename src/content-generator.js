...
const TREATMENT_MAP = {
  ...
  'flat-warts': { name: '거우침 + 한약 면역치료', desc: '편평사마귀는 병변의 양상에 따라 치료법이 달라진다. (1) 활동성 사마귀(붉고 부풀며 빠르게 번지는 상태)는 섣불리 제거하면 재발·전염되므로 한약 복용을 통한 면역치료가 원칙이며, 이 시기는 면역반응으로 사마귀가 한꺼번에 탈락하는 "면역치료의 골든타임"이다. (2) 6개월 이상 번짐이 없는 비활동성 사마귀는 화접몽 고유의 순수 한방 침 시술인 거우침으로 흉터 없이 제거한다. 활동성·비활동성이 혼재된 경우 의료진 판단으로 면역치료와 제거치료의 시기·방법을 조절한다. ※화안케어는 편평사마귀 치료에 사용하지 않음.' },
  ...
  'acne': { name: '화안케어 + 한약치료', desc: '외부 치료인 화안케어(미세약초침)로 각질탈락주기를 정상화하고 유수분 밸런스를 조절하며, 내과적으로는 한약치료(복용)로 반복되는 염증 경향을 체질적으로 개선하는 안팎 병행 치료. ※한약을 "도포"하는 것이 아니라 복용하는 한약치료임.' },
  'acne-scars': { name: '리셀테라피(복합 흉터치료)', desc: '화접몽의 복합 여드름흉터 치료 프로그램인 리셀테라피로 진행한다. 구성은 ① 한약도포 ② 화안케어 ③ 고밀도 AMTS ④ 화안케어의 단계로 이루어지며, 패인 흉터·색소침착을 개선하고 피부 재생과 장벽 회복을 돕는다. 리셀테라피는 연구논문으로 발표된 치료법이다.' },
