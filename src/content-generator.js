...
4. 도입부: 증상 묘사나 상황 서술로 시작하세요. "~하신 적 있으신가요?" 같은 질문형 도입 금지. "진료실에서~" 같은 의사 1인칭 시점도 금지합니다.
...
2. 어미: 모든 문장은 "~합니다", "~입니다", "~있습니다" 형태의 격식 서술체(~다 체)로 끝내세요. "~거든요", "~인데요" 같은 ~요 체 금지.
3. 문단: 한 <p>에 2~3문장만. 4줄 이상 금지.
4. 시점: 3인칭 블로그 글 시점. "진료실에서~", "저희 병원에서~" 같은 의사 화법 금지.
5. 금지 표현: 클릭베이트(충격, 놀라운 등), 과장된 치료 효과, 억지 질문형 도입("~있으신가요?")
6. 브랜드: "${BRAND.name}" 본문에서 2~3회만 자연스럽게 삽입
7. 구조: 전략(outline)에 정의된 구조를 따르되, 블로그처럼 읽기 쉬운 흐름으로 작성
8. 분량: 약 ${wordCount}자 내외
9. 전문 용어: 한의학 용어는 쉬운 비유와 함께 풀어서 설명
10. 마무리: "개인별 체질과 증상에 따라 치료 결과가 다를 수 있습니다." 면책 문구 필수
11. 다양성: 이전 콘텐츠와 다른 표현, 비유, 예시 사용
12. 토픽 집중: ${topic.name}에 대한 심도 있는 정보 중심
13. 언어: 한국어로만 작성. 의학 용어 영문 병기만 허용.
14. 출처: 학술 논문/연구 인용 절대 금지. 일반적 의학 상식만 활용.
${caseStudySafety}
...
다음 JSON 형식으로 작성된 콘텐츠를 출력하세요:
{
  ...
  "content": "HTML 본문 (<h2>, <p> 위주, 한 <p>에 2~3문장, ~다 체 어미, 약 ${wordCount}자)",
  ${faqJsonField}
