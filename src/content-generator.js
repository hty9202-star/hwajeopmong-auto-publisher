...
const TREATMENT_MAP = {
  ...
  '등여드름': { name: '화안케어', desc: '등여드름은 화접몽한의원의 화안케어(미세약초침)로 등 부위의 각질탈락주기를 정상화하고 유수분 밸런스를 조절하여 개선하는 외부 치료법이다. 미세한 약초침으로 한약 추출물을 피부에 직접 전달해 피지·염증 문제를 관리한다. ※등여드름은 화안케어만 언급하고, 한약 복용 등 다른 치료법은 언급하지 말 것.' },
